...
class Visualization3RS extends RenderScriptScene {
    ...
    protected ScriptC createScript() {
        ...
        sb.setScript(mResources, R.raw.spectrum);
        sb.setRoot(true);
    ...
    void updateWave() {
        ...
        for(int i = 0; i < outlen; i++) {
            ...
            mPointData[i*4+1] = mAnalyzer[i] / 100;
            mPointData[i*4+2]   = i - half;
            mPointData[i*4+3] = -mAnalyzer[i] / 100;
        }
        mPointAlloc.data(mPointData);
